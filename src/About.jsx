...
const About = () => (
  <>
    <Helmet>
      <title>About Us - SSD Education</title>
      <meta
        name="description"
        content="Join the top training institute in Coimbatore offering online courses, skill development programs, internships, and 100% placement support."
      />
      <meta
        name="keywords"
        content="online courses Coimbatore, skill development, IT training Coimbatore, internships in Coimbatore, placement training, courses in saranapatti, best courses in saranapatti, python, c, c++, java, Mern, Tally, Marketing, offline courses, full-time courses, hands-on training, certificate courses"
      />
    </Helmet>
        ...
        <div className="row py-lg-5">
          <div className="col-lg-8 col-md-10 mx-auto">
            ...
            <p className="lead text-muted mt-3">
              ...
              everyone, everywhere. Our platform combines cutting-edge
              technology with proven pedagogical methods to foster a new
        ...
        <div className="container">
          <div className="row align-items-center gx-5">
            ...
            <div className="col-lg-6">
              ...
              <p className="text-muted">
                Our goal is to provide an engaging, flexible, and effective
                online learning environment where students can thrive and
                achieve their career aspirations. We believe in learning by
                doing, which is why our courses are packed with real-world
            ...
            {[
              ...
              <div className="col-lg-3 col-md-6" key={stat.label}>
                <div className="card h-100 border-0 shadow-sm p-4 about-stat-card">
                  <div
                    className={`bg-${stat.color}-soft text-${stat.color} rounded-circle p-3 mx-auto mb-3 d-inline-flex align-items-center justify-content-center feature-icon-lg`}
                  >
                    <stat.icon size={36} />
                  </div>
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              ...
              <p className="text-muted">
                ...
                affordable, and accessible education that bridges the gap
            ...
            <div className="col-lg-6">
              ...
              <p className="text-muted">
                ...
                for our innovative teaching methods, comprehensive curriculum,
                and commitment to student success. We envision a world where
                anyone can build a better future through learning.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="lead text-muted mb-4">
                Join a community of learners and start building the skills for
                the future you want. Explore our courses and find your path to
                success today.
              </p>
              <Link
                to="/courses"
